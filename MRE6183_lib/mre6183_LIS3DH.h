#ifndef __MRE6183_LIS3DH_H			//Define to prevent recursive inclusion
#define __MRE6183_LIS3DH_H
...
#define LIS3DH_RANGE_16_G		0x3   // +/- 16g
#define LIS3DH_RANGE_8_G		0x2   // +/- 8g
#define LIS3DH_RANGE_4_G		0x1   // +/- 4g
#define LIS3DH_RANGE_2_G		0x0   // +/- 2g (default value)
#define LIS3DH_AXIS_X				0x1
#define LIS3DH_AXIS_Y				0x2
#define LIS3DH_AXIS_Z				0x4
#define LIS3DH_DATARATE_400_HZ					0x7   //  400 Hz
#define LIS3DH_DATARATE_200_HZ					0x6   //  200 Hz
#define LIS3DH_DATARATE_100_HZ					0x5   //  100 Hz
#define LIS3DH_DATARATE_50_HZ						0x4   //   50 Hz
#define LIS3DH_DATARATE_25_HZ						0x3   //   25 Hz
#define LIS3DH_DATARATE_10_HZ						0x2   //   10 Hz
#define LIS3DH_DATARATE_1_HZ						0x1   //    1 Hz
#define LIS3DH_DATARATE_POWERDOWN				0x0
#define LIS3DH_DATARATE_LOWPOWER_1K6HZ	0x8
#define LIS3DH_DATARATE_LOWPOWER_5KHZ		0x9

void LIS3DH_init(void);
void LIS3DH_write_command(uint8_t reg, uint8_t val);
uint8_t LIS3DH_read_command(uint8_t reg);
void LIS3DH_measure(float *Temp_Accel);

#endif /*__MRE6183_LIS3DH_H */
